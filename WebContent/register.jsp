...
<!-- IMPORTAR ETIQUETAS DE STRUTS Y STRUTS DOJO -->
			...
			<table border="1">
				...
				<s:iterator value="listRegisters">
					...
					<tr>
						...
						<td><s:url id="editURL" action="edita">
